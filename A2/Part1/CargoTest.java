...
public class CargoTest {
	...
	public static void main(String[] args) {
		...
		toLoad[1] = new Box(101, 40); 		 //Box: max weight 40, #1
		toLoad[2] = new WoodCrate(102, 80);  //WoodCrate: max weight 80, #2
		toLoad[3] = new MetalCrate(103, 100); //MetalCrate: max weight 100, #3
